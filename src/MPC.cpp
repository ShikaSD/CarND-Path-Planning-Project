...
public:
    ...
    FG_eval(Eigen::VectorXd &coeffs, double ref_speed) {
      this->coeffs = coeffs;
...
vector<double> MPC::Solve(Eigen::VectorXd &x0, Eigen::VectorXd &coeffs, double ref_speed) {
